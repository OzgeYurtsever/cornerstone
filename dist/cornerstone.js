/*! cornerstone-core - 0.0.0-semantically-released - 2023-11-18 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstone */
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f0e9fe6ede82ff7b831d";
...
function getRenderCanvas(enabledElement, image, invalidated) {
  ...
  if (renderCanvas.width !== image.width || renderCanvas.height !== image.height) {
    console.log(' ---> initializeRenderCanvas in renderColorImage');
...
function getRenderCanvas(enabledElement, image, invalidated) {
  ...
  // Sizes frequently.
  if (renderCanvas.width !== image.width || renderCanvas.height !== image.height) {
    console.log(' ---> initializeRenderCanvas in renderLabelMap');
